...
namespace GiftApi.Tests.User
{
    ...
    public class LoginUserHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _handler = new LoginUserHandler(_db, _validator, _configuration);
        }
        ...
        private async Task SeedUserAsync(string userName, string password)
        {
            var user = new GiftApi.Core.Entities.User
            {
                ...
                Type = GiftApi.Common.Enums.User.UserType.User
            };
        ...
        public async Task Should_Fail_When_UserName_Does_Not_Exist()
        {
            ...
            result.UserMessage.Should().Contain("Incorrect username or password");
        }
        ...
        public async Task Should_Fail_When_Validator_Fails()
        {
            ...
            result.UserMessage.Should().Contain("UserName is required");
            result.UserMessage.Should().Contain("Password is required");
        }
    }
}
